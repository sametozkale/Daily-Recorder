    ...
    <>
      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger
          id="occurred_on"
          className={cn(
            "flex h-9 w-full min-w-0 cursor-pointer items-center justify-between gap-2 rounded-lg border border-input bg-transparent px-2.5 py-1 text-left text-base transition-colors outline-none [corner-shape:round] md:text-sm",
